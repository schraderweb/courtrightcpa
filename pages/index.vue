...
<head>
    ...
    <title> Courtright Accounting Solutions LLC | Coming Soon</title>
                   ...
                   <div class="col-lg-5">
                       <div class="header-topbar-layout2">
                           <div class="phone-number">
                               <i class="flaticon-call-answer"></i> (616) 481-2097
                           </div>
                           <span>Call today for a free test.</span>
                       </div>
                   </div>
                   <div class="col-lg-2">
                       <div class="logo-area">
                           <a href="/" class="temp-logo">
                               <img src="/images/logo-main.jpg" alt="logo" class="img-fluid" width="150" />
                           </a>
                       </div>
                   </div>
                       ...
                       <div class="header-action-layout1">
                           <ul>
                               <li class="header-action-btn">
                                   <a href="/contact-us" class="item-btn">GET A FREE ESTIMATE</a>
                               </li>
                           </ul>
                       </div>
                   </div>
                           ...
                           <ul>
                               ...
                               <li>
                                   ...
                                   <ul class="dropdown-menu-col-1">
                                       ...
                                       <li>
                                           <a href="/paver-cleaning">Paver Cleaning</a>
                                       </li>
                                       <li>
        ...
        <div class="row min-vh-100" style="background-image: url('images/coming soon.jpg'); background-size: cover;background-position: center;  background-repeat: no-repeat;">
            <div class="col-xl-5 col-lg-7 col-md-7 p-5 p-lg-4 d-flex align-items-center" style="background-color: rgba(255, 255, 255, 0.5); height: 91vh !important;">
                <div class="mt-5 pl-5 ml-5">
                  ...
                  <!--  <p> <img src="images/logo.png" alt="companylogo"></p> -->
            ...
            <div class="col-xl-4 col-lg-5 col-md-4 col-sm-12 p-5 p-lg-4 d-flex align-items-center text-center bg-light" style=" ">
                <div class="mt-5">
                    ...
                    <p class="lead display-4 text-white mt-3 " style="width: 360px">
                        <a class="btn btn-success p-2 m-3 w-100" href="tel:+12314091834" style="font-size: 0.8em; border-radius: 12px;">
...
<!--<footer class="footer-wrap-layout1" style="min-height: 5vh !important;">-->
<!--    <div class="footer-bottom-wrap-layout1">-->
<!--        <div class="container">-->
<!--            <div class="copyright">-->
<!--                Copyright © 2014- 2023 Anchor Pro Wash | Website developed &-->
<!--                hosted by-->
<!--                <a href="https://schrader.co/"> Schrader Web Solutions </a>-->
<!--            </div>-->
